...
import 'package:akarak/main.dart';
...
class _ChatUsersListState extends State<ChatUsersList> {
  ...
  Future<void> _onRefresh() async {
    await AppBloc.initCubit.onLoad(isChatUsers: true);
  }
  ...
  Future<void> _onchat(ChatUserModel item) async {
    // await AppBloc.chatCubit.onLoadMore().then((value) => null);
    Navigator.pushNamed(context, Routes.chat, arguments: item).then((value) {
            ...
            AppButton(
              ...
              onPressed: () async {
                ...
                if (result1 && result2) {
                  ...
                  Navigator.pop(context);
                  AppBloc.initCubit.onSettingsLoad();
                } else {
  ...
  Widget build(BuildContext mainContext) {
    ...
    AppBloc.initCubit.onLoad(isChatUsers: true);
