    ...
    final result = await showModalBottomSheet<LocationModel?>(
      ...
      builder: (BuildContext context) => AppBottomPicker(
        picker: PickerModel(
          ...
          data: Application.submitSetting.locations,
        ),
        // hasScroll: true,
      ),
    );
                      ...
                      SizedBox(
                        ...
                        child: TextButton(
                          child: Column(
                              ...
                              children: [
                                Text(
                                  Application.currentCountry?.title ?? '',
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodyMedium!
                                      .copyWith(
                    ...
                    SafeArea(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          _buildCompanies(recentPosts),
                          _buildRecent(recentPosts),
