...
class _ProductDetailState extends State<ProductDetail>
  ...
  Widget _buildContent(ProductModel? product) {
              ...
              child: Row(
                ...
                children: <Widget>[
                  Padding(
                      ...
                      child: Text(group.title, textAlign: TextAlign.center))
                ],
              ),
            ),
          );
    ...
    if (_indexTab == 0) {
      ///Address
      if (product != null) {
        if (product.extendedAttributes.any((element) => true)) {
          content = SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                return mainData;
  ...
  Widget buildLocation() {
    ...
    list.add(
      InkWell(
        onTap: () {},
        child: Text(
          _productDetailCubit.product!.category!.title,
              ...
              children: <Widget>[
                Container(
                  constraints: BoxConstraints(
                      maxWidth: MediaQuery.of(context).size.width * 0.8),
                  child: Text(
                    "${_productDetailCubit.product!.city!.title}, ${_productDetailCubit.product!.state!.title} ,${_productDetailCubit.product!.country!.title} ,${_productDetailCubit.product!.extendedAttributes.singleWhere((e) => e.key == "address").text ?? ""}",
                    maxLines: 2,
                    textAlign: TextAlign.center,
                    overflow: TextOverflow.visible,
                    style: Theme.of(context).textTheme.bodyMedium,
    ...
    return BlocProvider(
        ...
        child: BlocBuilder<ProductDetailCubit, ProductDetailState>(
          ...
          return Scaffold(
            ...
            body: BlocBuilder<InitCubit, InitState>(builder: (context, state) {
                    ...
                    SliverPinnedHeader(
                      child: Card(
                        ...
                        child: Padding(
                            ...
                            child: Text(
                              _productDetailCubit.product?.title ?? "",
                              textAlign: TextAlign.center,
                            )),
                        // CardHeaderWidget(
                    ...
                    children: [
                      if (_productDetailCubit.product != null)
                        ElevatedButton(
                          ...
                          child:
                              Text(Translate.of(context).translate('contact')),
                        ),
                      if (_productDetailCubit.product != null &&
                          AppBloc.userCubit.state != null &&
                          AppBloc.userCubit.state!.id !=
                              _productDetailCubit.product!.createdBy!.id)
                        ElevatedButton(
                          style: ButtonStyle(
                              foregroundColor: MaterialStateProperty.all<Color>(
                                  Colors.white),
                          ...
                          onPressed: () {
                            Navigator.pushNamed(context, Routes.chat,
                                arguments:
                                    _productDetailCubit.product!.createdBy);
                          },
                          child: Text(
