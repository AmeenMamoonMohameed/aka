        ...
        return InkWell(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const SizedBox(height: 8),
              Text(
                "${item!.price} ${Application.submitSetting.currencies.singleWhere((cur) => cur.id == item?.currency?.id).code}",
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: Theme.of(context)
                    .textTheme
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                "${item!.state?.title}, ${item!.city?.title}, ${item!.extendedAttributes.singleWhere((e) => e.key == "address").text}",
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: Theme.of(context).textTheme.caption,
                              ),
